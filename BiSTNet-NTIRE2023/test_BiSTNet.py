...
if __name__ == "__main__":
    ...
    parser.add_argument("--clip_path", type=str, default="../demo_dataset2/input", help="path of input clips")
    parser.add_argument("--ref_path", type=str, default="../demo_dataset2/ref", help="path of refernce images")
    parser.add_argument("--output_path", type=str, default="../demo_dataset2/output", help="path of output clips")
